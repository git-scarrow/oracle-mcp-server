...
export const LANE_CONSTRAINTS = {
  ...
  bayview: { can_code: true, can_browse: true, can_deploy: false, write_scope: 'repo', max_timeout_s: 3600 },
  'bayview-thinking': { can_code: false, can_browse: true, can_deploy: false, write_scope: 'none', max_timeout_s: 2400 },
  'bayview-tuning': { can_code: true, can_browse: true, can_deploy: false, write_scope: 'repo', max_timeout_s: 3600 },
